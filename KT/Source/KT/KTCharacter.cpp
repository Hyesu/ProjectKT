...
void AKTCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAxis("MoveRight", this, &AKTCharacter::MoveRight);

	//PlayerInputComponent->BindTouch(IE_Pressed, this, &AKTCharacter::TouchStarted);
	//PlayerInputComponent->BindTouch(IE_Released, this, &AKTCharacter::TouchStopped);
}
